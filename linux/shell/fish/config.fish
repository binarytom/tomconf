...
set -U fish_user_paths /home/lieh/.cargo/bin /usr/local/sbin /usr/local/bin /usr/bin /bin
...
setenv OS_USERNAME lieh_666@foxmail.com
setenv OS_TENANT_NAME usersandbox_lieh
